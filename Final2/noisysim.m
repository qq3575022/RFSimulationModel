...
lambda = 3*10^8/f; lambda2 = 3*10^8/(f+0.29*10^9); lambda3 = 3*10^8/(f-0.1*10^9);
...
if abs(phi_prev_mod2_gt - phi_mod2_gt) > 1
    offset2 = offset2 + pi*sign(phi_prev_mod2_gt - phi_mod2_gt);
end
...
rdot  = 3*10^8/(4*pi)*(phi_prev_mod_gt_load -phi_mod2_gt)/(0.29*10^9);%lambda/(4*pi)*phi_mod*1/T;
