...
figure
subplot(4,1,1),plot(time, phi1,'LineWidth',2);%hold on; plot(time, r_sim1_,'LineWidth',2);title('Simulated Magnitude from Reader $\#1$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,2),plot(time, phi2,'LineWidth',2);%hold on; plot(time, r_sim2_,'LineWidth',2);title('Simulated Magnitude from Reader $\#2$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,3),plot(time, phi3,'LineWidth',2);%hold on; plot(time, r_sim3_,'LineWidth',2);title('Simulated Magnitude from Reader $\#3$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,4),plot(time, phi4,'LineWidth',2);%hold on; plot(time, r_sim4_,'LineWidth',2);title('Simulated Magnitude from Reader $\#4$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
%%
figure
subplot(4,1,1),plot(time, r_sim1_,'LineWidth',2);hold on; plot(time, radial(1,:),'LineWidth',2);title('Simulated Magnitude from Reader $\#1$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,2),plot(time, r_sim2_,'LineWidth',2);hold on; plot(time, radial(2,:),'LineWidth',2);title('Simulated Magnitude from Reader $\#2$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,3),plot(time, r_sim3_,'LineWidth',2);hold on; plot(time, radial(3,:),'LineWidth',2);title('Simulated Magnitude from Reader $\#3$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
subplot(4,1,4),plot(time, r_sim4_,'LineWidth',2);hold on; plot(time, radial(4,:),'LineWidth',2);title('Simulated Magnitude from Reader $\#4$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
%%
figure
subplot(4,1,1),plot(time, r_sim1,'LineWidth',3);hold on; plot(time, r_sim1_,'LineWidth',3);title('Recovered Radial Distance from Reader $\#1$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Recovered','Ground Truth','location','NorthEast')
subplot(4,1,2),plot(time, r_sim2,'LineWidth',3);hold on; plot(time, r_sim2_,'LineWidth',3);title('Recovered Radial Distance from Reader $\#1$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Recovered','Ground Truth','location','SouthEast')
subplot(4,1,3),plot(time, r_sim3,'LineWidth',3);hold on; plot(time, r_sim3_,'LineWidth',3);title('Recovered Radial Distance from Reader $\#1$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Recovered','Ground Truth','location','SouthEast')
subplot(4,1,4),plot(time, r_sim4,'LineWidth',3);hold on; plot(time, r_sim4_,'LineWidth',3);title('Recovered Radial Distance from Reader $\#1$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Recovered','Ground Truth','location','NorthEast')
% r_sim1 = 0.75*r_sim1+3.0993;
% r_sim2 = -r_sim2+1.85;
% r_sim3 = -r_sim3+1.75;
% r_sim4 = -r_sim4+1.59;
%%
...
save('time.mat', 'time')
% figure
% subplot(4,1,1),plot(time, r_sim1+2.37,'LineWidth',2);hold on; plot(time, r_sim1_,'LineWidth',2);title('Simulated Magnitude from Reader $\#1$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
% subplot(4,1,2),plot(time, r_sim2+0.94,'LineWidth',2);hold on; plot(time, r_sim2_,'LineWidth',2);title('Simulated Magnitude from Reader $\#2$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
% subplot(4,1,3),plot(time, r_sim3+2.39,'LineWidth',2);hold on; plot(time, r_sim3_,'LineWidth',2);title('Simulated Magnitude from Reader $\#3$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
% subplot(4,1,4),plot(time, r_sim4+2.27,'LineWidth',2);hold on; plot(time, r_sim4_,'LineWidth',2);title('Simulated Magnitude from Reader $\#4$ in 3D','interpreter','latex');ylabel('Magnitude [V]');xlabel('t [s]');grid on; grid minor;
%%
figure
...
%%
figure
subplot(2,1,1),plot(time, -0.9*rdot_sim2+1.85,'LineWidth',3);hold on; plot(time, radial(2,:),'LineWidth',2);title('Simulated Radial Distance from Reader $\#2$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Simulation','Ground Truth','location','SouthEast');ylim([1.55, 1.9])
subplot(2,1,2),plot(time, -rdot_sim4+1.59,'LineWidth',3);hold on; plot(time, radial(4,:),'LineWidth',2);title('Simulated Radial Distance from Reader $\#4$ in 3D','interpreter','latex');ylabel('Radial Distance [m]');xlabel('t [s]');grid on; grid minor;legend('Simulation','Ground Truth');ylim([1.42, 1.9])
