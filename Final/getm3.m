...
for i = 1:1:length(D) - 10000
   ...
   % moment8 = mean(D(i:i+10000).^8);
    ...
    m2(i) = (-2*moment2^2 + moment4 - moment2*sqrt(2*moment2^2 - moment4))/(moment2^2 - moment4); %abs(moment1^2/(moment2 - moment1^2));%(-2*moment2^2 + moment4 - moment2*sqrt(2*moment2^2 - moment4))/(moment2^2 - moment4);
