...
r_meas1= NaN(1,length(coord3));  rphase1= NaN(1,length(coord3)); phigt1_1= NaN(1,length(coord3)); phigt2_1= NaN(1,length(coord3)); phi1_1 = NaN(1,length(coord3)); phi2_1 = NaN(1,length(coord3));
r_meas2= NaN(1,length(coord3));  rphase2= NaN(1,length(coord3)); phigt1_2= NaN(1,length(coord3)); phigt2_2= NaN(1,length(coord3)); phi1_2 = NaN(1,length(coord3)); phi2_2 = NaN(1,length(coord3));
r_meas3= NaN(1,length(coord3));  rphase3= NaN(1,length(coord3)); phigt1_3= NaN(1,length(coord3)); phigt2_3= NaN(1,length(coord3)); phi1_3 = NaN(1,length(coord3)); phi2_3 = NaN(1,length(coord3));
r_meas4= NaN(1,length(coord3));  rphase4= NaN(1,length(coord3)); phigt1_4= NaN(1,length(coord3)); phigt2_4= NaN(1,length(coord3)); phi1_4 = NaN(1,length(coord3)); phi2_4 = NaN(1,length(coord3));
