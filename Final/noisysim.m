function [v, v2, r, r2, r3, rdot, rdot2, phi_mod_gt, phi_mod_gt2, phi_mod, phi_mod2, offset1, offset2, offset3, offset4] = noisysim(x,f,Gt,M,X,PT,GT,GR,R,sigma,k,z,z_prev,phi_prev_mod_gt_load, phi_prev_mod_load, T, Hmeas, offset1, offset2, offset3, offset4)
% ============================================= Magnitude =================================================

lambda = 3*10^8/f; lambda2 = 3*10^8/(f+0.1*10^7);
...
%phi_prev_mod_gt_load = exp(phi_noise)*phi_prev_mod_gt_load;
...
rdot  = 3*10^8/(4*pi)*(phi_prev_mod_load -phi_mod2)/(0.1*10^7);%lambda/(4*pi)*phi_mod*1/T;
